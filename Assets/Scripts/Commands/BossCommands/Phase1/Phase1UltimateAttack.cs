...
public class Phase1UltimateAttack : BossCommand
{
    ...
    public Phase1UltimateAttack(BossController boss) : base(boss) { }
    public override IEnumerator Execute()
    {
        ...
        for (int k = 0; k < attackCount; k++)
        {
            ...
            playerCell = GridManager.Instance.WorldToCell(playerObject.transform.position);
